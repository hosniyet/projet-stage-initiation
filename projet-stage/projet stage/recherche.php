...
<a href="https://www.biat.com.tn/ "><div class="preimg">
    ...
    <div class="f">
    <form name="f1"method="post" action="afficher.php">
        <h1>Recherche un stagiaire par son numéro d identité<h1>
        <input id="input1"type="text" name="cin" placeholder="donner le numéro d'identité"/>
